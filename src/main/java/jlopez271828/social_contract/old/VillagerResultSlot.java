...
public class VillagerResultSlot extends Slot {

    private final VillagerMenuContainer slots;
    private final Player player;
    private int removeCount;
    private final Merchant merchant;

    public VillagerResultSlot(final Player player, final Merchant merchant, final VillagerMenuContainer slots, final int id, final int x, final int y) {
        super(slots, id, x, y);
        this.player = player;
